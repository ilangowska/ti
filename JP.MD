...
obwód kola z dolaczeniem #include , żeby liczylo pi /jako M_PI/ ,czyli podstawi samodzielnie wartosć
...
Obwód i pole kola z zastosowaniem puts do opisów
i podwójnego getchar do przechodzenia dalej enterem
...
Zastosowanie while. Zamiana stopni F na C od 0 do 50 ale wynik z dokladnocia do jednej po przecinku,
czyli zamieniamy int na double i %d na %lf
...
zastosowanie for do poprzedniego przykladu #define LOWER 0 i przy #define STEP 0 daje niekonczaca sie petle i żeby wyjsc to ctrl+c
zmiana STEP na np. 20 daje normalna petle
